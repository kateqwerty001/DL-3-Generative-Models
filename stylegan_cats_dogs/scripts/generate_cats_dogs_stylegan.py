...
RUN_DIR         = Path("/home2/faculty/kbokhan/DL-3-Generative-Models/stylegan_runs_cats_dogs/00000-cats_dogs128-mirror-auto1-kimg1000-noaug")

N_GEN           = 4000
N_REAL          = 4000
REAL_DIR        = Path("outputs/fid_real")
LOG_PATH        = Path("outputs_cats_dogs/stylegan_fid_results.csv")
GRIDS_DIR       = Path("outputs_cats_dogs/stylegan_grids")
DATA_DIR        = Path("/home2/faculty/kbokhan/data/cats_dogs")
