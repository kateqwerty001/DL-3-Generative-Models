...
def get_cat_dataloaders(root_dir, batch_size=64, image_size=128, num_workers=4, model_type="vqvae", val_size=500, test_size=500, seed=42):
    ...
    if train_size <= 0:
        raise ValueError("Dataset is too small for the specified val and test sizes.")
